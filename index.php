...
<section class="top" id="landingPage">
        <header>
            <p><a href="#landingPage" class="landing-direct">Burger Thikana</a></p>
            <ul class="navbar">
   ...
   <!--Section that'll contain the hero section and image-->
    ...
    <!--About section below-->
        <section class="about-section" id="About">
            <div class="left-right-main">
                ...
                <div class="right">
                    <h2>About</h2>
                    <p class="about-text">We the Burger Thikana. We are here in your city to provide you guys with the best in class food items in affordable prices. Best in raw materials is used to give to best healthy food.</p>
    ...
    <section class="menu-section" id="Menu">
        <div class="food-container">
            ...
            <h2>Menu</h2>
            <p class="food1">Here comes the real deal - our Menu. You will be able to find the best food items which are freshly prepared by our chefs. Our menu consists from burger to salad and from softdrinks to refreshing drinks. With the coming we will introducing more items so that you can enjoy more!</p>
